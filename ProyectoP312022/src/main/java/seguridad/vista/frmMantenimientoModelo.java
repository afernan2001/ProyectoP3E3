...
import seguridad.modelo.daoModelo;
 ...
 * @author visitante
 */
public class frmMantenimientoModelo extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        List<clsModelo> modeladores = modeloDAO.select();
        tablaVendedores.setModel(modelo);
        String[] dato = new String[4];
        for (int i = 0; i < modeladores.size(); i++) {
            dato[0] = Integer.toString(modeladores.get(i).fGetid_modulo());
            dato[1] = modeladores.get(i).fGetcodigo();
            dato[2] = modeladores.get(i).fGetnombre();
            dato[3] = modeladores.get(i).fGetstatus();
    ...
    public void buscarVendedor() {
        clsModelo modeloAConsultar = new clsModelo();
        daoModelo modeloDAO = new daoModelo();
        modeloAConsultar.fSetid_modulo(Integer.parseInt(txtbuscado.getText()));
        modeloAConsultar = modeloDAO.query(modeloAConsultar);
        txtCodigo.setText(modeloAConsultar.fGetcodigo());        
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        daoModelo modeloDAO = new daoModelo();
        clsModelo modeloAEliminar = new clsModelo();
        modeloAEliminar.fSetid_modulo(Integer.parseInt(txtbuscado.getText()));
        modeloDAO.delete(modeloAEliminar);
        llenadoDeTablas();
    }//GEN-LAST:event_btnEliminarActionPerformed

    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        daoModelo modeloDAO = new daoModelo();
        clsModelo modeloAInsertar = new clsModelo();
        modeloAInsertar.fSetcodigo(txtCodigo.getText());
        modeloAInsertar.fSetnombre(txtNombre.getText());
        modeloAInsertar.fSetestatus(txtEstatus.getText());
        modeloDAO.insert(modeloAInsertar);
        llenadoDeTablas();
...
//        // TODO add your handling code here:
        daoModelo modeloDAO = new daoModelo();
        clsModelo modeloAActualizar = new clsModelo();
        modeloAActualizar.fSetid_modulo(Integer.parseInt(txtbuscado.getText()));
        modeloAActualizar.fSetcodigo(txtCodigo.getText());
        modeloAActualizar.fSetnombre(txtNombre.getText());
        modeloAActualizar.fSetestatus(txtEstatus.getText());
        modeloDAO.update(modeloAActualizar);
        llenadoDeTablas();
